...
export default function TOSPage() {
    return (
        <div className="text-ui-fg-base max-w-3xl mx-auto bg-white p-6 md:p-8 mt-8 mb-8 rounded-md text-black">
            <h1 className="text-3xl sm:text-4xl font-bold text-center mb-6 text-gray-900">
                Terms of Service (TOS) - Abyss Walker
            </h1>
            ...
            <h2 className="text-2xl font-semibold mb-4 text-gray-800">4. Accounts</h2>
            <p className="mb-4 text-black">
            ...
            <p className="mb-6 text-black">
                ...
                property of EI Abyss Walker and its licensors. The Service
                is protected by copyright, trademark, and other laws of both France
                ...
                written consent of EI Abyss Walker.
                The code used to create parts of the Service is available in the GitHub repository and is licensed under the AGPL V3 license
                and may be used in accordance with the terms of that license. For more information, please refer to the GitHub.
            </p>
            ...
            <p className="mb-4 text-black">
                ...
                are not owned or controlled by EI Abyss Walker.
            </p>
            <p className="mb-4 text-black">
                EI Abyss Walker has no control over, and assumes no
                responsibility for, the content, privacy policies, or practices of any
                third-party web sites or services. You further acknowledge and agree
                that EI Abyss Walker shall not be responsible or liable,
            ...
            <p className="mb-6 text-black">
                You agree to defend, indemnify and hold harmless EI Abyss Walker
            ...
            <p className="mb-6 text-black">
                In no event shall EI Abyss Walker, nor its directors,
            ...
            <p className="mb-6 text-black">
                EI Abyss Walker its subsidiaries, affiliates, and its
            ...
            <p className="mb-4 text-black">
                ...
                of France, without regard to its conflict of law
                provisions.
            </p>
            <p className="mb-4 text-black">
            ...
            <h2 className="text-2xl font-semibold mb-4 text-gray-800">12. Changes</h2>
            <p className="mb-4 text-black">
