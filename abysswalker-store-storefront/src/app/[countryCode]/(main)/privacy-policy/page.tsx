export default function PrivacyPolicyPage() {
    return (
        <div className="text-ui-fg-base max-w-4xl mx-auto bg-white p-6 md:p-8 mt-8 mb-8 rounded-md text-black">
            ...
            <ul className="list-disc pl-6 mb-4">
                <li className="mb-1">To provide and maintain our Service, including processing your orders and managing your account.</li>
                <li className="mb-1">To facilitate secure payment processing through Stripe.</li>
                <li className="mb-1">To communicate with you about your orders, account, or any inquiries you make.</li>
                <li className="mb-1">To improve the technical performance and functionality of our Service.</li>
                <li className="mb-1">To detect, prevent, and address technical issues or fraudulent activity.</li>
            ...
            <ul className="list-disc pl-6 mb-4">
                <li className="mb-2">
                    ...
                    <ul className="list-circle pl-6 mt-1">
                        ...
                        <li className="mb-1">
                            <strong>Website Hosting:</strong> Hetzner, for hosting our shop's infrastructure.
                        </li>
                    </ul>
            ...
            <ul className="list-disc pl-6 mb-4">
                <li className="mb-1">Access, update, or delete your personal information.</li>
                <li className="mb-1">Object to the processing of your personal information.</li>
                <li className="mb-1">Request that we restrict the processing of your personal information.</li>
                <li className="mb-1">Withdraw your consent at any time where we rely on your consent to process your personal information.</li>
                <li className="mb-1">Receive a copy of your personal information in a structured, commonly used, and machine-readable format.</li>
            </ul>
            <p className="mb-4">
            ...
            <p className="mb-1"><strong>EI Abyss Walker</strong></p>
            <p className="mb-1">Email: <a href="mailto:abysswalkershop@gmail.com" className="text-blue-600 hover:underline">abysswalkershop@gmail.com</a></p>
            <p>39 rue Victor Hugo 97200 Fort de France, Martinique</p>
        </div>
    );
}