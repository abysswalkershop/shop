            ...
            <Html className="font-sans bg-gray-100">
                ...
                <Body className="bg-white my-10 mx-auto w-full max-w-2xl">
                    ...
                    <Container className="px-6">
                        ...
                        <Text className="text-gray-800 text-base leading-relaxed">
                            Great news! Your order <strong>#{order.display_id}</strong> has been completed and delivered to your address.
                        </Text>

                        <Section className="bg-gray-50 p-4 rounded-lg my-6">
                            <Text className="text-gray-700 font-semibold text-base m-0 mb-2">Order Summary:</Text>
                            <Text className="text-gray-600 text-sm m-0">Order ID: #{order.display_id}</Text>
                            <Text className="text-gray-600 text-sm m-0">Total Amount: {formatPrice(order.total)}</Text>
                            <Text className="text-gray-600 text-sm m-0">Delivery Address: {order.shipping_address?.address_1}, {order.shipping_address?.city}</Text>
                        </Section>

                        <Text className="text-gray-800 text-base leading-relaxed">
                            We hope you love your purchase! If you're satisfied with your order, we'd appreciate it if you could leave us a review.
                        </Text>

                        <Text className="text-gray-800 text-base leading-relaxed">
                            If you have any questions or need support, please don't hesitate to reach out to our team at contact@abysswalker.org.
                        </Text>

                        <Text className="text-gray-800 text-base leading-relaxed">
                            Thank you for choosing ABYSSWALKER and we look forward to serving you again.
                        </Text>
                    </Container>
